...
$reviews = $reviews_model->ctrw_get_reviews('approved');

// Get plugin settings to determine how many reviews to show.
$settings = get_option('customer_reviews_settings', []);
$reviews_to_show = $settings['reviews_per_row_slder'] ?? 3;
$reviews = array_slice($reviews, 0, $reviews_to_show);
...
<div class="ctrw-slider-container">
   ...
   <div class="ctrw-slider-navigation-wrapper">
       <div class="ctrw-slider-wrapper">
           <div class="ctrw-slider-slides <?php if ($review_count < ($settings['reviews_per_row_slder'] ?? 3)) echo 'center-items'; ?>">
               <?php
